...
public static partial class WebInjection
{
    public static async Task TransformIndex(string path, Stream stream)
    {
        ...
        const string assets = """
            <link data-jellyspotlight rel="stylesheet" href="/JellySpotlight/Client.css?v=0.3.10.0">
            <script data-jellyspotlight defer src="/JellySpotlight/Client.js?v=0.3.10.0"></script>
            """;
